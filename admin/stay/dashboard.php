...
<ul class="li1">
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">                                                               <!-- use for button style--->
                <div class="col-md-12">                                                        <!-- use for button distance--->
                    <div class="mt-5 mb-3 clearfix">
                        <!-- <h1 class="pull-left">Booking Data</h1> -->
                        <!-- <a href="../stay/stay.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Booking</a> -->
                    </div>
                    <?php
                    // Include config file
